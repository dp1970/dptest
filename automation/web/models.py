...
class UserProfile(models.Model):
    ...
    用户表
    """
    name = models.CharField(verbose_name="用户名称", unique=True,max_length=200)
    ...
    department = models.CharField(verbose_name='部门',choices=(("0", "开发"), ("1", "测试"), ("2", '运维')), blank=True, null=True, max_length=10)
